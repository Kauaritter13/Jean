...
import { Heart, Mail, Lock, Loader2, Sparkles, Star, Home } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-secondary/30 via-background to-primary/5 p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <Home className="absolute top-1/2 right-[15%] w-5 h-5 text-accent/20 animate-float stagger-4" />
      </div>
      ...
      <Card className="w-full max-w-md relative animate-fade-in-scale backdrop-blur-sm bg-card/95 border-border/50 shadow-2xl">
        ...
        <CardHeader className="text-center space-y-4 pt-8">
          <div className="mx-auto relative">
            ...
            <Sparkles className="absolute -bottom-1 -right-1 w-6 h-6 text-accent animate-sparkle" />
          </div>
          <div>
            <CardTitle className="text-2xl font-serif flex items-center justify-center gap-2">
              ...
              Bem-vindo de volta!
              <Heart className="w-5 h-5 text-primary animate-heart-beat stagger-1" />
            </CardTitle>
            <CardDescription className="mt-2">Entre para gerenciar sua lista de presentes</CardDescription>
          </div>
        </CardHeader>
